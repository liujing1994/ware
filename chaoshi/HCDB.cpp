...
BOOL CHCDBApp::InitInstance()
{
	AfxEnableControlContainer();
     ::CoInitialize(NULL);
    ConnectSql("Provider=SQLOLEDB.1;Persist Security Info=False;User ID=sa;Password=;Initial Catalog=Sales");
    ConnectMaster("Provider=SQLOLEDB.1;Persist Security Info=False;User ID=sa;Password=;Initial Catalog=master");
    CRESTOREDLG dlg;
	dlg.DoModal();
...
void CHCDBApp::ConnectSql(CString sqlstr)
{
...
void CHCDBApp::ConnectMaster(CString sqlstr)
{
